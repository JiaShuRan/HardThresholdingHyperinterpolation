...
switch domain_type
    ...
    otherwise
        ...
        text(1.2,0,0,'$A$',Interpreter='latex',FontSize=40);
        text(0,1.05,0,'$B$',Interpreter='latex',FontSize=40);
        text(0,0,1.08,'$C$',Interpreter='latex',FontSize=40);
        xlabel('$x$','interpreter','latex','FontSize',40,'FontWeight','bold')
        ylabel('$y$','interpreter','latex','FontSize',40,'FontWeight','bold')
        zlabel('$z$','interpreter','latex','FontSize',40,'FontWeight','bold')
        title('Spherical triangle','interpreter','latex','FontSize',50,'FontWeight','bold')
        grid on
        colorbar;
        view(115,20)
end
