...
% Hard thresholding and its error
...
title('\textbf{Hard thresholding hyper.}','interpreter','latex', 'fontsize', fontsize_baselinet),...
grid on, set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off'), view(-36,15), colorbar('eastoutside'), caxis([0,0.7])
...
slice(XR_3,YR_3,ZR_3,pXYZR_3D_plot(3).matrix,xslice,yslice,zslice),set(gca, 'fontsize', fontsize_baselinea),...
...
slice(XR_3,YR_3,ZR_3,abs_err_3D_plot(3).matrix,xslice,yslice,zslice),set(gca, 'fontsize', fontsize_baselinea),... 
title('\textbf{Absolute error}','interpreter','latex', 'fontsize', fontsize_baselinet),...
grid on, set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off'),  view(-36,15),colorbar('eastoutside'), caxis([0,0.25])
