...
%-------------------------------------------------------------------------
LV=50;      % Hyperinterpolant total degree.
NV=100;     % Points of the rule used for hyperintepolation. 
NR=120;     % Points used by the reference rule (testing L2 errors).
...
plot(X,gX,'linewidth',2,'color','k'), box on,...
    ...
    xlabel('$o$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('$f(x)$','interpreter','latex', 'fontsize', fontsize_baseline),...
    title('\textbf{Exact function}','interpreter','latex', 'fontsize', fontsize_baselinet),...
     grid on,...
     set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off'),axis([-1,1,-0.5,1.5]),
...
%     set(gca, 'fontsize', fontsize_baselinea),...
%     xlabel('$x$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('$f(x)$','interpreter','latex', 'fontsize', fontsize_baseline),...
%     title('\textbf{Hard thresholding hyper.}','interpreter','latex', 'fontsize', fontsize_baselinet),  grid on,...
%      set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off'),axis([-1,1,-0.5,1.5]),
...
% plot(XR,pXR(:,3),'linewidth',2,'color','k'),box on,set(gca, 'fontsize', fontsize_baselinea), ...
%      xlabel('$x$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('$f(x)$','interpreter','latex', 'fontsize', fontsize_baseline),...
...
% plot(XR,abs(gXR-pXR(:,3)),'linewidth',2,'color','k'),set(gca, 'fontsize', fontsize_baseline),...
%     xlabel('$x$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('Absolute error','interpreter','latex', 'fontsize', fontsize_baseline),...
%     title('\textbf{Absolute error}','interpreter','latex', 'fontsize', fontsize_baselinet),box on,axis([-1,1,0,1]), grid on,...
%      set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off')
% 
% %Classical hyper. and its error
% axes('position',[0.75 0.55 0.2 0.40]),
% plot(XR,pXR(:,6),'linewidth',2,'color','k'),box on,set(gca, 'fontsize', fontsize_baselinea), ...
%      xlabel('$x$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('$f(x)$','interpreter','latex', 'fontsize', fontsize_baseline),...
%      title('\textbf{Hyperinterpolation}','interpreter','latex', 'fontsize', fontsize_baselinet),...
%      grid on,...
%      set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off'),axis([-1,1,-0.5,1.5]),
% axes('position',[0.75 0.05 0.2 0.40]), 
% plot(XR,abs(gXR-pXR(:,6)),'linewidth',2,'color','k'),set(gca, 'fontsize', fontsize_baselinea), xlabel('$x$','interpreter','latex', 'fontsize', fontsize_baseline),...%ylabel('Absolute error','interpreter','latex', 'fontsize', fontsize_baseline),...
%     title('\textbf{Absolute error}','interpreter','latex', 'fontsize', fontsize_baselinet),box on,axis([-1,1,0,1]),grid on,...
%      set(gca, 'XMinorGrid', 'off'), set(gca, 'YMinorGrid', 'off')
