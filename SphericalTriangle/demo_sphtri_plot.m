...
title('\textbf{Exact function}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
...
set(fg,'EdgeColor', 'none');
title('\textbf{Noisy function}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
...
set(fg,'EdgeColor', 'none');
title('\textbf{Hard thresholding hyper.}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
...
colormap(jet(255));
view(125,8), axis vis3d, axis equal tight, colorbar('south'),caxis([min(abs(p_XR(:,3)-g_XR)),max(abs(p_XR(:,3)-g_XR))])
axis off

% Lasso hyper. and its error
axes('position',[0.525 0.55 0.2 0.47])
fg = trisurf(tri, XR(:,1), XR(:,2), XR(:,3), p_XR(:,3),'facecolor','interp');
set(fg,'EdgeColor', 'none');
title('\textbf{Lasso hyper.}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
view(125,8), axis vis3d, axis equal tight, colorbar('south'),caxis([min(p_XR(:,5)),max(p_XR(:,5))]),
axis off

axes('position',[0.525,0.05,0.2,0.47])
fg = trisurf(tri, XR(:,1), XR(:,2), XR(:,3), abs(p_XR(:,3)-g_XR),'facecolor','interp');
set(fg,'EdgeColor', 'none');
title('\textbf{Absolute error}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
view(125,8), axis vis3d, axis equal tight, colorbar('south'),caxis([min(abs(p_XR(:,3)-g_XR)),max(abs(p_XR(:,3)-g_XR))])
...
set(fg,'EdgeColor', 'none');
title('\textbf{Hyperinterpolation}','interpreter','latex','fontsize',fontsize_baselinet,'position',[0,0,1])
colormap(jet(255));
view(125,8), axis vis3d, axis equal tight, colorbar('south'),caxis([min(p_XR(:,5)),max(p_XR(:,5))]),
axis off
